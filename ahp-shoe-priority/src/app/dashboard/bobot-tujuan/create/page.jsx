    ...
    return (
        <>
            ...
            <div className={` w-full max-w-screen-sm p-5 fixed z-40 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-md drop-shadow-sm border`}>
                <div className="mb-5">
                    <h1>Tambah Bobot Tujuan Baru</h1>
                </div>
                ...
                <form onSubmit={handleCreateKriteria}>
                    ...
                    {/* NAMA KRITERIA */}
                    {/* ============================================================================= */}
                    <TextFieldComponent id="tujuan" name="Tujuan" value={naamaKriteria} onChange={(e) => setNaamaKriteria(e.target.value)} required={true}/>

                    {/* ============================================================================= */}
                    {/* BOBOT KRITERIA */}
                    {/* ============================================================================= */}
                    <div className="relative flex flex-col gap-2 mb-5">
                        <label htmlFor="bobot" className="text-md text-gray-500 capitalize">Bobot Tujuan</label>
